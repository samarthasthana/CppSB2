...
${OBJECTDIR}/_ext/2109343375/BinSearchMod.o: ../CppSB2/BinSearchMod.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/2109343375/BinSearchMod.o ../CppSB2/BinSearchMod.cpp

${OBJECTDIR}/_ext/2109343375/Btree_2.o: ../CppSB2/Btree_2.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/2109343375
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/2109343375/Btree_2.o ../CppSB2/Btree_2.cpp

${OBJECTDIR}/_ext/2109343375/ReverseSent.o: ../CppSB2/ReverseSent.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/2109343375
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/2109343375/ReverseSent.o ../CppSB2/ReverseSent.cpp
...
${OBJECTDIR}/_ext/2109343375/main.o: ../CppSB2/main.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/2109343375
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/2109343375/main.o ../CppSB2/main.cpp

${OBJECTDIR}/ListLoop.o: ListLoop.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/ListLoop.o ListLoop.cpp
